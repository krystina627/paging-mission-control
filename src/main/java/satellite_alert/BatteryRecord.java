...
public class BatteryRecord extends SatelliteRecord {

	public BatteryRecord(LocalDateTime dateTime, int satelliteId, int redHighLimit, int yellowHighLimit,
			int yellowLowLimit, int redLowLimit, float rawValues, String component) {
		super(dateTime, satelliteId, redHighLimit, yellowHighLimit, yellowLowLimit, redLowLimit, rawValues, component);
